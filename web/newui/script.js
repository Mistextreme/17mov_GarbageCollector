...
window.addEventListener('message', function (event) {
    ...
    if (action == "addNewMember") {
        ...
        $("#counter").fadeOut(250)
        $(".header .bgText").text("GARBAGE LOBBY")
        $(".header .text").text("GARBAGE LOBBY")
        $("#inviteScreen").fadeOut(250)
        $("#warningScreen").fadeOut(250)
        $("#tutorialScreen").fadeOut(250)
        ...
        $("#counterValue").text(`Collected garbage: ${0}%`)
        $("#counter").fadeIn(250)
        counterActive = true
        ...
        $("#counterValue").text(`Collected garbage: ${event.data.value.toString()}%`)
